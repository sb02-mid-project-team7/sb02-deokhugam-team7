...
@Component
@StepScope
public class BookRankUpdateTasklet implements Tasklet {

  private final BookSearchService bookSearchService;

  private Period period;

  public BookRankUpdateTasklet(BookSearchService bookSearchService, @Value("#{jobParameters['period']}") String periodStr) {
